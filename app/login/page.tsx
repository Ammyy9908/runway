  ...
  return (
    <div className="min-h-screen bg-black text-white selection:bg-white selection:text-black">
      ...
      <nav className="flex items-center justify-between p-6 max-w-7xl mx-auto w-full">
        ...
        <Link href="/signup" className="px-4 py-1.5 text-sm font-medium border border-zinc-800 rounded-md hover:bg-zinc-900 transition-colors">
          Sign Up
        </Link>
      </nav>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              ...
              <button className="relative w-full flex items-center justify-center gap-3 px-4 py-3 bg-black border border-zinc-800 rounded-md hover:bg-zinc-900 transition-colors group">
                ...
                <span className="absolute -top-2 -right-2 px-2 py-0.5 text-[10px] font-bold bg-blue-600 text-white rounded-sm uppercase tracking-wider">
                  Last Used
                </span>
              </button>
